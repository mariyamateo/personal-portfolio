export const SKILLS_LIST = [
  ...
  },
  {
    ...
    link: "https://www.figma.com/@macky1",
  },
  {
    id: 12,
    name: "Tailwind CSS",
...
export const WORK_LIST = [
  ...
  },
  {
    ...
    role: "Frontend Developer",
    work: [
      "Created and styled a basic HTML page using CSS.",
      "Added interactivity to a website using JavaScript events.",
...
export const SKILLS_DESC = [
  ...
  },
  {
    ...
    caption:
      "Creating visual elements for your brand, including logos, icons, and more. Developing interactive elements like websites and mobile apps.",
    border: "#67F5B1",
  },
  {
    id: 2,
